...
IF(ISIXE_WITH_NETWORK)
	IF(WIN32 AND NOT ANDROID AND NOT EXISTS "${I6ENGINE_DEP_DIR}/m2etis/")
		execute_process(COMMAND ${CMAKE_SOURCE_DIR}/dependencies/build-m2etis.bat ${VS_TOOLCHAIN} ${VS_ARCH} "${I6ENGINE_DEP_DIR}" "${CMAKE_BINARY_DIR}/m2etisIncludes" "${M2ETIS_CONFIG_DIR}" WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/dependencies)
	...
	IF(UNIX AND NOT ANDROID AND NOT EXISTS "${I6ENGINE_DEP_DIR}/m2etis/")
		execute_process(COMMAND ${CMAKE_SOURCE_DIR}/dependencies/build-m2etis.sh ${UNIX_COMPILER}  "${I6ENGINE_DEP_DIR}" "${CMAKE_BINARY_DIR}/m2etisIncludes" "${M2ETIS_CONFIG_DIR}" WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/dependencies)
