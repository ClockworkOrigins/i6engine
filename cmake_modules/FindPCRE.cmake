...
IF(NOT WIN32)
        find_package_handle_standard_args(PCRE DEFAULT_MSG PCRE_INCLUDE_DIR PCRE_PCRE_LIBRARY PCRE_PCREPOSIX_LIBRARY PCRE_PCRECPP_LIBRARY)
        mark_as_advanced(PCRE_INCLUDE_DIR PCRE_LIBRARIES PCRE_PCREPOSIX_LIBRARY PCRE_PCRE_LIBRARY PCRE_PCRECPP_LIBRARY)
        set(PCRE_LIBRARIES ${PCRE_PCRE_LIBRARY} ${PCRE_PCREPOSIX_LIBRARY} ${PCRE_PCRECPP_LIBRARY})
        MESSAGE(STATUS "  libraries : ${PCRE_LIBRARIES}")
ELSE()
