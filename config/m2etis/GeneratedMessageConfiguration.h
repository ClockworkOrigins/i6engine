...
//BOOST_CLASS_EXPORT_GUID(i6e::api::GameMessage, "2")
//BOOST_CLASS_IMPLEMENTATION(i6e::api::GameMessage, boost::serialization::object_serializable)
//BOOST_CLASS_EXPORT_GUID(i6e::api::GameMessageStruct, "3")
...
BOOST_CLASS_EXPORT_GUID(m2etis::message::NullFilterInfo<i6e::api::GameMessage>, "5") // TODO: (Roland) check if necessary
BOOST_CLASS_IMPLEMENTATION(m2etis::message::NullFilterInfo<i6e::api::GameMessage>, boost::serialization::object_serializable)
...
, m2etis::pubsub::filter::NullFilter<i6e::api::GameMessage, m2etis::net::NetworkType<m2etis::net::clockTCP> >
...
, m2etis::pubsub::partition::NullPartition<m2etis::net::NetworkType<m2etis::net::clockTCP>, i6e::api::GameMessage>
, m2etis::pubsub::security::NullSecurity, m2etis::pubsub::rendezvous::NullRendezvous>, i6e::api::GameMessage> Direct_Null_Null_Null_Null_Null_DirectBroadcast_Null_GameMessage_TCPMessage;
