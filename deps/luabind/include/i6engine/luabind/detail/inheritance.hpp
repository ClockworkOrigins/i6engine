...
#ifndef __LUABIND_DETAIL_INHERITANCE_HPP__
# define __LUABIND_DETAIL_INHERITANCE_HPP__
...
namespace detail {
	...
	template<class T>
	struct registered_class<T const> : registered_class<T> {};

} /* namespace detail */
} /* namespace luabind */

#endif /* __LUABIND_DETAIL_INHERITANCE_HPP__ */
