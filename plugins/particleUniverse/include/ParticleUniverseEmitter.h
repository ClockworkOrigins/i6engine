...
namespace ParticleUniverse {
    ...
    */
	...
	public:
		...
		/** Todo
	    */
		inline ParticleTechnique * getParentTechnique() const { return mParentTechnique; }
		void setParentTechnique(ParticleTechnique * parentTechnique);

		/** Todo
	    */
		inline const String & getEmitterType() const { return mEmitterType; }
	    ...
	    */
		...
		/** Todo
	    */
		inline DynamicAttribute * getDynAngle() const { return mDynAngle; }
		void setDynAngle(DynamicAttribute * dynAngle);

		/** Todo
	    */
		inline DynamicAttribute * getDynEmissionRate() const { return mDynEmissionRate; }
		void setDynEmissionRate(DynamicAttribute * dynEmissionRate);

		/** Todo
	    */
		inline DynamicAttribute * getDynTotalTimeToLive() const { return mDynTotalTimeToLive; }
		void setDynTotalTimeToLive(DynamicAttribute * dynTotalTimeToLive);

		/** Todo
	    */
		inline DynamicAttribute * getDynParticleMass() const { return mDynParticleMass; }
		void setDynParticleMass(DynamicAttribute * dynParticleMass);

		/** Todo
	    */
		inline DynamicAttribute * getDynVelocity() const { return mDynVelocity; }
		void setDynVelocity(DynamicAttribute * dynVelocity);

		/** Todo
	    */
		inline DynamicAttribute * getDynDuration() const { return mDynDuration; }
		void setDynDuration(DynamicAttribute * dynDuration);
		void setDynDurationSet(bool durationSet);

		/** Todo
	    */
		inline DynamicAttribute * getDynRepeatDelay() const { return mDynRepeatDelay; }
		void setDynRepeatDelay(DynamicAttribute * dynRepeatDelay);
		void setDynRepeatDelaySet(bool repeatDelaySet);

		/** Todo
	    */
		inline DynamicAttribute * getDynParticleAllDimensions() const { return mDynParticleAllDimensions; }
		...
		*/
		inline Real _initParticleTimeToLive();
	    ...
	    */
		const ColourValue & getParticleColour() const;
	    ...
	    */
		const ColourValue & getParticleColourRangeStart() const;
	    ...
	    */
		const ColourValue & getParticleColourRangeEnd() const;
	    ...
	    */
		const uint16 & getParticleTextureCoords() const;
	    ...
	    */
		const uint16 & getParticleTextureCoordsRangeStart() const;
	    ...
	    */
		const uint16 & getParticleTextureCoordsRangeEnd() const;
	...
	protected:
	    ...
	    */
		...
		@par
			This should be typically used for a 1 camera setup, since using 2 cameraŽs would result in wrong 
