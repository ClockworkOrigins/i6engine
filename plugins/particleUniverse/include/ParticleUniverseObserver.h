...
namespace ParticleUniverse {
	...
	*/
	...
	public:
		...
		/** Todo
	    */
		const String & getObserverType() const { return mObserverType; }
	    ...
	    */
		...
		/** Todo
	    */
		const Particle::ParticleType & getParticleTypeToObserve() const { return mParticleTypeToObserve; }
	    ...
	    */
		Real getObserverInterval() const;
