...
namespace ParticleUniverse {
    ...
    */
	...
	public:
		GroupsMask() {}
		GroupsMask(uint32 nbits0, uint32 nbits1, uint32 nbits2, uint32 nbits3) : bits0(nbits0), bits1(nbits1), bits2(nbits2), bits3(nbits3) {}
		~GroupsMask() {}
	...
	*/
	...
	public:
		// Constructors
		PhysicsShapeDesc() : mCollisionGroup(0), mAngularVelocity(Vector3::ZERO), mAngularDamping(0.5), mMaterialIndex(0) {
			mGroupMask.bits0 = 0;
			mGroupMask.bits1 = 0;
			mGroupMask.bits2 = 0;
			mGroupMask.bits3 = 0;
    ...
    */
	...
	public:
		// Constructors
		PhysicsSphereDesc() : mRadius(1.0) {
			mPhysicsShapeType = ST_SPHERE;
		}

		PhysicsSphereDesc(const Real radius) : PhysicsShapeDesc(), mRadius(radius) {
			mPhysicsShapeType = ST_SPHERE;
		}
			
		// Copy Constructor
		PhysicsSphereDesc(const PhysicsSphereDesc & physicsSphereDesc) : PhysicsShapeDesc(physicsSphereDesc) {
    ...
    */
	...
	public:
		// Constructors
		PhysicsBoxDesc() : mDimensions(Vector3::UNIT_SCALE) {
			mPhysicsShapeType = ST_BOX;
		}

		PhysicsBoxDesc(const Vector3 dimensions) : PhysicsShapeDesc(), mDimensions(dimensions) {
			mPhysicsShapeType = ST_BOX;
		}

		// Copy Constructor
		PhysicsBoxDesc(const PhysicsBoxDesc & physicsBoxDesc) : PhysicsShapeDesc(physicsBoxDesc) {
    ...
    */
	...
	public:
		// Constructors
		PhysicsCapsuleDesc() : mRadius(1.0), mHeight(100.0) {
			mPhysicsShapeType = ST_CAPSULE;
		}

		PhysicsCapsuleDesc(const Real radius, const Real height) : PhysicsShapeDesc(), mRadius(radius), mHeight(height) {
			mPhysicsShapeType = ST_CAPSULE;
		}

		// Copy Constructor
		PhysicsCapsuleDesc(const PhysicsCapsuleDesc & physicsCapsuleDesc) : PhysicsShapeDesc(physicsCapsuleDesc) {
