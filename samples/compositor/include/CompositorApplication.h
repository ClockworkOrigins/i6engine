...
#ifndef __I6ENGINE_SAMPLES_COMPOSITORAPPLICATION_H__
#define __I6ENGINE_SAMPLES_COMPOSITORAPPLICATION_H__
...
namespace sample {
	...
	class CompositorApplication : public i6engine::api::Application {
	public:
	...
	private:
		...
		void setCompositor(const std::string & compositor, bool enabled) const;
	};

} /* namespace sample */

#endif /* __I6ENGINE_SAMPLES_COMPOSITORAPPLICATION_H__ */
