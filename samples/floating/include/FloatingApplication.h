...
#ifndef __I6ENGINE_SAMPLES_FLOATINGAPPLICATION_H__
#define __I6ENGINE_SAMPLES_FLOATINGAPPLICATION_H__
...
namespace sample {
	...
	class FloatingApplication : public i6engine::api::Application {
	public:
		FloatingApplication();
...
#endif /* __I6ENGINE_SAMPLES_FLOATINGAPPLICATION_H__ */
