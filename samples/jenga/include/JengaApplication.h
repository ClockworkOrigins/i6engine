...
#ifndef __I6ENGINE_SAMPLES_JENGAAPPLICATION_H__
#define __I6ENGINE_SAMPLES_JENGAAPPLICATION_H__
...
namespace sample {
	...
	class JengaApplication : public i6engine::api::Application {
	public:
		JengaApplication();
...
#endif /* __I6ENGINE_SAMPLES_JENGAAPPLICATION_H__ */
