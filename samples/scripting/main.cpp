...
#if ISIXE_SCRIPTING == SCRIPTING_LUA
	i6e::api::EngineController::GetSingletonPtr()->registerSubSystem("Scripting", new i6e::modules::LuaScriptingController(), LNG_SCRIPTING_FRAME_TIME);
#elif ISIXE_SCRIPTING == SCRIPTING_PYTHON
	i6e::api::EngineController::GetSingletonPtr()->registerSubSystem("Scripting", new i6e::modules::PythonScriptingController(), LNG_SCRIPTING_FRAME_TIME);
#endif
