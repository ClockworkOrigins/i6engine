...
#ifndef __I6ENGINE_SAMPLES_SHADOWAPPLICATION_H__
#define __I6ENGINE_SAMPLES_SHADOWAPPLICATION_H__
...
namespace sample {
	...
	class ShadowApplication : public i6engine::api::Application {
	public:
		ShadowApplication();
...
#endif /* __I6ENGINE_SAMPLES_SHADOWAPPLICATION_H__ */
