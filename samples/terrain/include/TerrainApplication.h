...
#ifndef __I6ENGINE_SAMPLES_TERRAINAPPLICATION_H__
#define __I6ENGINE_SAMPLES_TERRAINAPPLICATION_H__
...
namespace sample {
	...
	class TerrainApplication : public i6engine::api::Application {
	public:
		TerrainApplication();
...
#endif /* __I6ENGINE_SAMPLES_TERRAINAPPLICATION_H__ */
