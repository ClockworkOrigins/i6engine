...
scope registerGUI() {
	return
		...
		class_<i6e::api::gui::SubscribeEvent>("SubscribeEvent")
			.def(constructor<>())
		...
		def("subscribeEvent", &i6e::lua::gui::subscribeEventString),
		def("subscribeEvent", &i6e::lua::gui::subscribeEvent),
		def("changeEvent", &i6e::lua::gui::changeEvent),
		def("setMouseCursorImage", static_cast<void(*)(const std::string &)>(&i6e::lua::gui::setMouseCursorImage)),
		def("setMouseCursorImage", static_cast<void(*)(const std::vector<std::string> &, double, bool)>(&i6e::lua::gui::setMouseCursorImage)),
		...
		def("setImage", static_cast<void(*)(const std::string &, const std::string &, const std::string &)>(&i6e::lua::gui::setImage)),
		def("setImage", static_cast<void(*)(const std::string &, const std::vector<std::pair<std::string, std::string>> &, double, bool)>(&i6e::lua::gui::setImage)),
