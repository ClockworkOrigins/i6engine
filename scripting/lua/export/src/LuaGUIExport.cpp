...
scope registerGUI() {
	return
		...
		def("setMouseCursorImage", (void(*)(const std::string &)) &i6e::lua::gui::setMouseCursorImage),
		def("setMouseCursorImage", (void(*)(const std::vector<std::string> &, double, bool)) &i6e::lua::gui::setMouseCursorImage),
		...
		def("setImage", (void(*)(const std::string &, const std::string &, const std::string &)) &i6e::lua::gui::setImage),
		def("setImage", (void(*)(const std::string &, const std::vector<std::pair<std::string, std::string>> &, double, bool)) &i6e::lua::gui::setImage),
