...
scope registerInput() {
	return
		class_<i6engine::api::KeyState>("KeyState")
			.def(constructor<>())
			.enum_("KeyState")
			[
				value("KEY_RELEASED", int(i6engine::api::KeyState::KEY_RELEASED)),
				value("KEY_PRESSED", int(i6engine::api::KeyState::KEY_PRESSED)),
				value("KEY_HOLD", int(i6engine::api::KeyState::KEY_HOLD))
			],

		class_<i6engine::api::KeyCode>("KeyCode")
			.def(constructor<>())
			.enum_("KeyCode")
			[
		...
		def("subscribeKeyEvent", &i6engine::lua::input::subscribeKeyEvent),
		def("unsubscribeKeyEvent", &i6engine::lua::input::unsubscribeKeyEvent),
		def("resetInputSubSystem", &i6engine::lua::input::resetInputSubSystem)
		;
}
