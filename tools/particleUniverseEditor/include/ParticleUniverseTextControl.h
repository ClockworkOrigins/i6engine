...
public:
	TextControl(ParticleUniverseEditorFrame * frame, wxWindow * parent, wxWindowID id, const wxString & value = wxT(""), const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize, long style = 0, const wxValidator & validator = wxDefaultValidator, const wxString & name = wxTextCtrlNameStr);
	virtual ~TextControl() {}
	...
	*/
	...
	bool getHighlightKeywords() const;
