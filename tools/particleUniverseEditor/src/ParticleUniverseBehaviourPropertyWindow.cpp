...
BehaviourPropertyWindow::BehaviourPropertyWindow(BehaviourPropertyWindow * behaviourPropertyWindow) : PropertyWindow(behaviourPropertyWindow->GetParent(), behaviourPropertyWindow->getOwner(), Ogre::StringUtil::BLANK) {
	_initProperties();
...
void BehaviourPropertyWindow::_initProperties() {
